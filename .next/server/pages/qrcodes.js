...
function QRCodeListPage({ qrCodes: initialQrcodes  }) {
    const [qrcodes, setQrcodes] = (0,react__WEBPACK_IMPORTED_MODULE_8__.useState)(initialQrcodes);
    async function handleDelete(id) {
        _lib_axios__WEBPACK_IMPORTED_MODULE_7__/* ["default"]["delete"] */ .Z["delete"](`/qrcodes/${id}`);
        setQrcodes((prevQrcode)=>prevQrcode.filter((qrcode)=>qrcode._id !== id));
    }
...
var __webpack_exports__ = __webpack_require__.X(0, [636,675,664,556,250,181,72], () => (__webpack_exec__(6906)));
