...
function ShortLinkListPage({ shortLinks: initialShortLinks  }) {
    ...
    async function handleDelete(id) {
        _lib_axios__WEBPACK_IMPORTED_MODULE_7__/* ["default"]["delete"] */ .Z["delete"](`/short-links/${id}`);
...
var __webpack_exports__ = __webpack_require__.X(0, [636,675,664,556,250,824,72], () => (__webpack_exec__(8377)));
